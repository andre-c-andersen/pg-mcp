...
def check_hypopg_installation_status(sql_driver: SqlDriver, message_type: Literal["plain", "markdown"] = "markdown") -> tuple[bool, str]:
    """
    ...
    """
    status = check_extension(sql_driver, "hypopg", include_messages=False)
